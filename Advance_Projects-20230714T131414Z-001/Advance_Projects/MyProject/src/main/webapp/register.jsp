...
<div id="mainBody">
	...
	<form class="form-horizontal" method="post" action ="UserController" >
		...
		<div class="control-group">
			...
			<div class="controls">
			 <select name ="usertype"  id="inputFname1"> 
	  ...
	  <div class="control-group">
		<label class="control-label" for="input_email">mobile <sup>*</sup></label>
		<div class="controls">
		  <input type="text" id="input_email" placeholder="Mobile" name = "mobile">
		</div>
	  </div>	
	  <div class="control-group">
	...
	<div class="control-group">
	  ...
	  <div class="control-group">
		...
		<div class="controls">
		  <input type="password" id="inputPassword1" placeholder=" Confirm Password" name="cpassword">
		</div>
	  </div>	  
	...
	<div class="control-group">
			<div class="controls">
				...
				<input class="btn btn-large btn-success" type="submit" name="action"value="Register" />
			</div>
		</div>		
	</form>
</div>
