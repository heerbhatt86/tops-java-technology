	...
	%>
			...
			<input type ="hidden" name="otp" value="<%=request.getAttribute("otp") %>">
			  <div class="control-group">
				<label class="control-label" for="inputEmail1">Enter OTP</label>
				<div class="controls">
				  <input class="span3"  type="text" id="inputEmail1" placeholder="otp" name = "uotp">
				</div>
			  </div>
			  <div class="controls">
			  <button type="submit" name="action" value ="verify OTP" class="btn block" >Submit</button>
			  </div>
			</form>
		</div>
		</div>
