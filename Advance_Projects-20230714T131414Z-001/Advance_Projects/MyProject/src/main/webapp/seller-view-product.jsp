...
<div id="mainBody">
	...
	<div class="row">
		...
		<h4>Latest Products </h4>
			  <ul class="thumbnails">
			  <%
			     List<product> list = productDao.getallproduct(u.getUid());
			     for(product p:list)
			     {
			  ...
			  %>
				<li class="span3">
				  <div class="thumbnail">
					<a  href="product_details.jsp"><img src="product_image/<%=p.getProduct_image() %>" alt="" style="width: 200px;height: 200px;"/></a>
					<div class="caption">
					  <h5><%=p.getProduct_name() %></h5>
					  <p>
					 
					 <b>price : <%=p.getProduct_price() %></b>
					 </p>
					 <a href=""><input type="button" value="Details" class="btn btn-primary"></a>
					</div>
				  </div>
				</li>
				<%
