	...
	<form class="form-horizontal" method="post" action ="ProductController" enctype="multipart/form-data" >
	 <input type ="hidden" name= "uid" value="<%=u.getUid()%>">
		...
		<div class="control-group">
			...
			<div class="controls">
			 <select   id="inputFname1" name="product_category"> 
		...
		<div class="control-group">
		<label class="control-label" for="input_email">Product description <sup>*</sup></label>
		<div class="controls">
		  <input type="text" id="input_email" placeholder="Product description" name ="product_desc">
		</div>
	  </div>
	  <div class="control-group">
		<label class="control-label" for="input_email">product image <sup>*</sup></label>
		<div class="controls">
		  <input type="file" id="input_email"  name ="product_image">
		</div>
	  </div>	
