...
<div class="container">
	...
	%>
		<form class="form-horizontal" method ="post" action ="ContactController">
        <fieldset>
          ...
          <div class="control-group">
              <textarea rows="3" id="textarea" class="input-xlarge" placeholder="Remarks" name="remarks"></textarea>
           
          </div>

            <button class="btn btn-large" type="submit" name="action" value="submit contact">Send Messages</button>
