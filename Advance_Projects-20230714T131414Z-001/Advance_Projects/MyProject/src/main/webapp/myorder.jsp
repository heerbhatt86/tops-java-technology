	...
	<div class="row">
		...
		<div class="span12">		
			...
			<div class="carousel-inner">
			  ...
			  %>
			  <%
			   List<cart> list=cartdao.getorderbyuser(u.getUid());
			   if(list.size()==0)
			   {
				   %>
			  ...
			  %>
				<li class="span3">
				  <div class="thumbnail">
				  <i class="tag"></i>
					<a href="product_details.jsp?pid=<%=p.getPid()%>"><img src="product_images/<%=p.getProduct_image() %>" alt=""></a>
					<div class="caption">
					  <h5><%=p.getProduct_name() %></h5>
					  <h4><a class="btn" href="product_details.jsp?pid=<%=p.getPid()%>">VIEW</a> <span class="pull-right"><%=p.getProduct_price() %></span></h4>
					</div>
				  </div>
				</li>
				<%
