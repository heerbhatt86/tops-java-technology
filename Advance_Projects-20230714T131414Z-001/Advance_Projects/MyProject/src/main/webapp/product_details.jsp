...
<div id="mainBody">
	...
	<div class="row">	  
            ...
            <a href="themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="product_images/<%= p.getProduct_image() %>" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="themes/images/products/large/f1.jpg"> <img style="width:29%" src="product_images/<%= p.getProduct_image() %>" alt=""/></a>
                   <a href="themes/images/products/large/f2.jpg"> <img style="width:29%" src="product_images/<%= p.getProduct_image() %>" alt=""/></a>
                   <a href="themes/images/products/large/f3.jpg" > <img style="width:29%" src="product_images/<%= p.getProduct_image() %>" alt=""/></a>
                  </div>
                  <div class="item">
                   <a href="themes/images/products/large/f3.jpg" > <img style="width:29%" src="product_images/<%= p.getProduct_image() %>" alt=""/></a>
                   <a href="themes/images/products/large/f1.jpg"> <img style="width:29%" src="product_images/<%= p.getProduct_image() %>" alt=""/></a>
			...
			<div class="span6">
				...
				<hr class="soft"/>
				  ...
				  <div class="control-group">
					<label class="control-label"><span><%=p.getProduct_price() %></span></label>
					<div class="controls">
					<%
					...
					{
					%>
					<a href="login.jsp"><button type="button" class="btn btn-large btn-primary pull-right"> login </button></a>
					<%
					}
					else
					{
				...
				c.setUid(u.getUid());
				c.setPid(p.getPid());
				boolean wishlistflag =wishlistdao.checkwishlist(w);
				boolean cartflag =cartdao.checkcart(c);
				if(wishlistflag==false)
				{
				%>
				
				<a href="add-to-wishlist.jsp?pid=<%= p.getPid()%>&uid=<%=u.getUid()%>"><button type="button" class="btn btn-large btn-primary pull-right"> Add to wishlist <i class=" icon-heart"></i></button></a>
				<%
				}
				else
				{
				%>
				<a href="remove-from-wishlist.jsp?pid=<%= p.getPid()%>&uid=<%=u.getUid()%>"><button type="button" class="btn btn-large btn-danger pull-right"> Remove from wishlist <i class=" icon-heart"></i></button></a>
				<%
				}
				%>
				<% 
				...
				<a href="add-to-cart.jsp?pid=<%= p.getPid()%>&uid=<%=u.getUid()%>"><button type="button" class="btn btn-large btn-primary pull-right"> Add to cart <i class=" icon-shoping-cart"></i></button></a>
				<%
				}
				else
				{
				%>
				<a href="remove-from-cart.jsp?pid=<%= p.getPid()%>&uid=<%=u.getUid()%>"><button type="button" class="btn btn-large btn-danger pull-right"> Remove from cart <i class=" icon-shoping-cart"></i></button></a>
				<%
				}
